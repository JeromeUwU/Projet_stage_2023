...
class BaseGAttN:
    ...
    def micro_f1(logits, labels, mask):
        ...
        tp = tf.compat.v1.count_nonzero(predicted * labels * mask)
        tn = tf.compat.v1.count_nonzero((predicted - 1) * (labels - 1) * mask)
        fp = tf.compat.v1.count_nonzero(predicted * (labels - 1) * mask)
        fn = tf.compat.v1.count_nonzero((predicted - 1) * labels * mask)
