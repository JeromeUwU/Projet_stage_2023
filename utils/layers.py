...
def attn_head(seq, out_sz, bias_mat, activation, in_drop=0.0, coef_drop=0.0, residual=False,
    ...
    with tf.name_scope('my_attn'):
        ...
        seq_fts = tf.compat.v1.layers.conv1d(seq, out_sz, 1, use_bias=False)#Projection des features
        ...
        coefs = tf.nn.softmax(tf.nn.leaky_relu(logits) + bias_mat)#Calcul des coeff alpha
        ...
        #ret représente l'opération de node level aggragating 
